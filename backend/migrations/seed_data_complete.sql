...
-- Step 1: Seed Physical Locations
...
-- Step 2: Seed Digital Locations (Non-subscription)
...
-- Step 2: Seed Digital Locations (Subscriptions)
INSERT INTO digital_locations (
    id,
    user_id,
    name,
...
-- Step 2: Seed Subscription Details
...
-- Step 3: Seed User Games (Digital)
...
-- Step 3: Seed Digital Game Locations
INSERT INTO digital_game_locations (
    user_game_id,
    digital_location_id,
    created_at
) VALUES
...
-- Step 3: Seed Physical Game Locations
INSERT INTO physical_game_locations (
    user_game_id,
    sublocation_id,
    created_at
) VALUES
...
-- Step 4: Seed One-Time Purchases
...
-- Seed monthly spending aggregates (updated to reflect actual spending)
...
-- Seed yearly spending aggregates (updated to reflect actual spending)
