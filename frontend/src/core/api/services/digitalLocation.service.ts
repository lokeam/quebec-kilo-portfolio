...
export const digitalLocationService = {
   ...
   */
  async createLocation(input: CreateDigitalLocationInput): Promise<DigitalLocation> {
    try {
   ...
   */
  async updateLocation(id: string, input: UpdateDigitalLocationInput): Promise<DigitalLocation> {
    try {
