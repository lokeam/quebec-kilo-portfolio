...
import { BILLING_CYCLES, type PaymentMethod, PAYMENT_METHODS } from '@/shared/constants/payment';
  ...
  currentTotalThisMonth: [
    {
      ...
      paymentMethod: PAYMENT_METHODS.VISA.displayName,
    ...
    },
    {
      ...
      amount: '14.99',
      spendTransactionType: 'subscription',
      paymentMethod: PAYMENT_METHODS.MASTERCARD.displayName,
      mediaType: PURCHASED_MEDIA_CATEGORIES.SUBSCRIPTION,
    ...
    },
    {
      ...
      paymentMethod: PAYMENT_METHODS.PAYPAL.displayName,
