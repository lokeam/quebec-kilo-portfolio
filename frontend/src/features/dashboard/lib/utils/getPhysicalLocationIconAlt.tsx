 ...
 * ```
 */
export function PhysicalLocationIconAlt({ type, bgColor }: PhysicalLocationIconProps) {
  ...
  switch (normalizedType) {
    case 'house':
      IconComponent = <Home className="h-56 w-56 text-white" />;
      break;
    case 'apartment':
      IconComponent = <Building2 className="h-56 w-56 text-white" />;
      break;
    case 'office':
      IconComponent = <Building className="h-56 w-56 text-white" />;
      break;
    case 'warehouse':
      IconComponent = <Warehouse className="h-56 w-56 text-white" />;
      break;
    case 'vehicle':
      IconComponent = <IconCar className="h-60 w-60 text-white" />;
      break;
    default:
      return null;
  }
